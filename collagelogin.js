...
await driver.findElement(By.id("txtUserName")).sendKeys("245121737173");
await driver.findElement(By.id("txtPassword")).sendKeys("245121737173");
await driver.findElement(By.id("btnSubmit")).click();
const user = await driver.findElement(By.id("lblHTNo")).getText();
assert.strictEqual(user, "245121737173");
console.log("success");await driver.findElement(By.id("Stud_cpModules_imgbtnExams")).click();
